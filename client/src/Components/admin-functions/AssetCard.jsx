...
const AssetCard = ({ asset }) => {
  ...
  const handleEdit = () => {
    const uniqueId = asset.unique_id;
    navigate(`/update-asset/${uniqueId}`);
  };

  return (
    <div className="relative">
      <div className="bg-white p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 w-96 h-100 relative mb-8">
        <img
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
          <div className="bg-white p-8 max-w-2xl rounded-md relative border-black border">
            <button
              ...
              className="absolute top-0 right-0 m-4 bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
            >
